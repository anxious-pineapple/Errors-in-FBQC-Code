...
class _UnitedStrCaller(_UnitedFuncCaller):
    ...
    def __call__(self, t, args={}):
        ...
        out.append(self.funclist[4](t, now_args))
        out.append(self.funclist[5](t, now_args))
        out.append(self.funclist[6](t, now_args))
        out.append(self.funclist[7](t, now_args))
        out.append(self.funclist[8](t, now_args))
        out.append(self.funclist[9](t, now_args))
